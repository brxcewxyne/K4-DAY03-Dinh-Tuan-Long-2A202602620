...
4. Sau khi nhận Observation, hãy kiểm tra mục tiêu gốc đã hoàn thành chưa. Nếu chưa, gọi công cụ tiếp theo bằng dữ liệu vừa nhận được.
5. Nếu Observation đã đủ để hoàn thành mục tiêu, hãy trả lời bằng văn bản và không gọi lại công cụ đã hoàn tất.
